...
#mysql目标服务器以及用户名和密码  
MYSQL_CMD="--host=192.168.1.176 --user=root --password=123456 --port=3306"    
  
MYSQL_UP=" --user=root --password='123456' --port=3306 "  #mysqladmin的用户名和密码  
